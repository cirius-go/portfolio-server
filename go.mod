module github.com/cirius-go/portfolio-server
...
require (
	...
	github.com/cirius-go/codegen v0.0.0-00010101000000-000000000000
...
replace github.com/cirius-go/codegen => ../codegen
